...
# Targets
################################################################################
all: arm-tf buildroot edk2 linux optee-os qemu soc-term oemcrypto ce-cdm
clean: arm-tf-clean buildroot-clean edk2-clean linux-clean optee-os-clean \
	qemu-clean soc-term-clean check-clean oemcrypto-clean
...
# OP-TEE
################################################################################
OPTEE_OS_COMMON_FLAGS += CFG_ARM64_core=y DEBUG=$(DEBUG) CFG_TEE_CORE_LOG_LEVEL=0 CFG_CORE_HEAP_SIZE=524288
...
oemcrypto: oemcrypto-common

ce-cdm:	ce-cdm-common

oemcrypto-help: oemcrypto-help-common

oemcrypto-clean: oemcrypto-clean-common
